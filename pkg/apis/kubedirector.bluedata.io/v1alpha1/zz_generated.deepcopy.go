...
func (in *KDSecret) DeepCopyInto(out *KDSecret) {
	*out = *in
	if in.KDSecretItems != nil {
		in, out := &in.KDSecretItems, &out.KDSecretItems
		*out = make([]KDSecretItem, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KDSecretItem) DeepCopyInto(out *KDSecretItem) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KDSecretItem.
func (in *KDSecretItem) DeepCopy() *KDSecretItem {
	if in == nil {
		return nil
	}
	out := new(KDSecretItem)
	in.DeepCopyInto(out)
	return out
}
